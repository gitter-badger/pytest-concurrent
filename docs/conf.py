# -*- coding: utf-8 -*-
#
# pytest-concurrent documentation build configuration file, created by
...
project = u'pytest-concurrent'
copyright = u'2015, Reverb Chu'
author = u'Reverb Chu'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-concurrent Documentation',
     [author], 1)
]
